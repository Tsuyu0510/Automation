...
## oracle -> hdfs 
#sqoop job --delete ora2hdfsjob
#sqoop job --create ora2hdfsjob -- import --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/test20221129job --incremental append --check-column 'LOAD_TIME' --last-value '2022-11-29' -m 1
#sqoop job --create ora2hdfsjob_forstore -- import --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store --incremental append --check-column 'LOAD_TIME' --last-value '2022-11-29' -m 1
#sqoop job --create ora2hdfsjob_updatetime -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime --incremental append --check-column 'UPDATE_TIME' --last-value '2022-12-06 12:00:00' -m 1
#sqoop job --create ora2hdfsjob_updatetime_store -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime_store --incremental append --check-column 'UPDATE_TIME' --last-value '2022-12-06' -m 1
#sqoop job --create ora2hdfsjob_updatetime_2 -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime --incremental append --check-column 'UPDATE_TIME' --last-value '2022-12-06 12:00:00' -m 1
#sqoop job --create ora2hdfsjob_updatetime_store_2 -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime_store --incremental append --check-column 'UPDATE_TIME' --last-value '2022-12-06 12:00:00' -m 1
#sqoop job --create ora2hdfsjob_loadtime_2 -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime --incremental lastmodified --append --check-column 'LOAD_TIME' --last-value '2022-12-06 12:00:00' -m 1
#sqoop job --create ora2hdfsjob_loadtime_store_2 -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --table DCMS.EC_O2OAPI_ORDERSOURCE --target-dir /user/hadoop/oracle_test/oracle_store_updatetime_store --incremental lastmodified --append --check-column 'LOAD_TIME' --last-value '2022-12-06 12:00:00' -m 1
#sqoop job --create ora2hdfsjob_loadtime_merge -- import --map-column-java UPDATE_TIME=java.sql.Timestamp,LOAD_TIME=java.sql.Timestamp,FINISH_TIME=java.sql.Timestamp --connect jdbc:oracle:thin:@192.168.91.8:1521:tdc --username daanalysis --password-file /sqoop/pwd/sqoopPWD.pwd --query "SELECT CONCAT(CONCAT(CONCAT(PARENTID,ESHOPID),PER_TRNO),MANAGECODE) AS TOTAL_KEY,PARENTID,ESHOPID,PER_TRNO,MANAGECODE,USER_ID,UPDATE_TIME,FOC_SHIPPINGCODE,ORDERNO,CHK_NO,REV_STNO,ORDERNM,ORDERTEL,ECSUPPLIERNAME,ITEM,ORDER_QTY,STATUS,ACCEPT_QTY,FREE,ITEM_ACCOUNT,SHIPMENTAMOUNT,TMSHIPPINGFEE,FOC_HASTMSHIPPINGFEE,DCMS_HASTMSHIPPINGFEE,CAR_NO,ROUTE,STEP,DIS_NO,PACKAGE,CHAN_NO,SERVICETYPE,PRODNM,DISTYPE,TDC_ARRIVE_DATE,OLD_TDC_ARRIVE_DATE,PLAN_RETURN_DATE,O_DATE,A_DATE,CATEGORY_NO,FOC_PAYBARCODE1,FOC_PAYBARCODE2,FOC_LOGIBARCODE,DCMS_PAYBARCODE1,DCMS_PAYBARCODE2,DCMS_LOGIBARCODE,ORD_STATUS,FOC_BATCH_ID,LOAD_TIME,RE51_LOCK_SEQ,RE51_DCMS_BATCHID,RE52_LOCK_SEQ,RE52_DCMS_BATCHID,FINISH_TIME,PACKDONE_BATCHID,DCMS_PACK_DC,DCMS_DISTR_DC,DCMS_REFUND_DC,DCMS_PACKBOX_TYPE,RE51_HQ_BATCHID,KAPS_PACK_SEQ,RE51_EXCH_BATCHID FROM DCMS.EC_O2OAPI_ORDERSOURCE WHERE LOAD_TIME>TO_DATE('2022-10-03 00:00:00','yyyy-mm-dd hh24:mi:ss') and \$CONDITIONS" --target-dir /user/hadoop/oracle_test/oracle_store_updatetime --incremental lastmodified --merge-key TOTAL_KEY --check-column 'LOAD_TIME' --last-value '2022-12-10 00:00:00' -m 1
